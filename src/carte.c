...
carte* get_liste_carte() {
    ...
    liste_carte[0] = new_carte("FISE", "La faction qui a pose cette carte gagne 1 point DDRS.", 4);
    liste_carte[1] = new_carte("FISA", "La faction qui a pose cette carte gagne 2 points DDRS si le nombre de cartes retournees sur le plateau (y compris celle-ci) est pair, et 0 sinon.", 4);
    liste_carte[2] = new_carte("FC", "La faction qui a pose cette carte gagne 4 points DDRS si au moins une autre carte FC est retournee sur le plateau et 0 sinon.", 4);
    liste_carte[3] = new_carte("EcologIIE", "La faction qui a pose cette carte gagne 1 point DDRS par carte FISE/FISA/FC retournee.", 2);
    liste_carte[4] = new_carte("lIIEns", "Prenez toutes les cartes FISE/FISA/FC retournees, retirez les du plateau, melangez les et reposez les face cachees une par une sur la gauche de la carte la plus en haut à gauche du plateau, dans cet ordre. Les prochaines cartes à être retournees sont ces cartes là.", 2);
    liste_carte[5] = new_carte("Soiree sans alcool", "Prenez toutes les cartes FISE/FISA/FC retournees, retirez les du plateau, melangez les et reposez les face cachees une par une sur la gauche de la carte la plus en haut à gauche du plateau, dans cet ordre. Les prochaines cartes à être retournees sont ces cartes là.", 1);
    ...
    liste_carte[7] = new_carte("Cafe", "Supprimez toutes les cartes The et Alcool retournees sur le plateau. Si une carte Ecocup est retournee sur le plateau, la faction qui a pose cette carte gagne 1 point DDRS. Sinon elle perd 1 point DDRS.", 1);
    liste_carte[8] = new_carte("The", "Supprimez toutes les cartes Cafe et Alcool retournees sur le plateau. Si une carte Ecocup est retournee sur le plateau, la faction qui a pose cette carte gagne 1 point DDRS. Sinon elle perd 1 point DDRS.", 3);
    liste_carte[9] = new_carte("Ecocup", "Cette carte est sans effet.", 1);
    liste_carte[10] = new_carte("Reprographie", "La faction adverse de celle qui a pose cette carte perd 1 points DDRS pour chaque paire de cartes retournees et identiques sur le plateau. (S'il y a 3 cartes identiques, cela fait 3 paires).", 1);
    liste_carte[11] = new_carte("Isolation du batiment", "Chaque faction gagne 1 point DDRS par carte non retournee et non supprimee du plateau qu'elle a posee sur le plateau.", 1);
    liste_carte[12] = new_carte("Parcours sobriete numerique", "Retournez toutes les cartes non retournees les plus à gauche et à droite de chaque ligne, sans appliquer leur effet.", 1);
    liste_carte[13] = new_carte("Heures supplementaires", "La faction adverse de celle qui a pose cette carte perd 3 points DDRS par carte Heures supplementaires retournee sur le plateau (y compris celle-ci).", 1);
    liste_carte[14] = new_carte("Kahina Bouchama", "Supprimez une carte non retournee du plateau choisie au hasard.", 1);
    liste_carte[15] = new_carte("Kevin Goilard", "Supprimez une ligne au hasard, la faction qui a pose cette carte gagne 2 points DDRS par carte supprimee ainsi.", 1);
    liste_carte[16] = new_carte("Massinissa Merabet", "La faction qui a pose cette carte reactive l'effet de la dernière carte retournee avant Massinissa Merabet, en faisant comme elle l'avait posee elle-même, même si ce n'est pas le cas.", 1);
    liste_carte[17] = new_carte("Vitera Y", "La faction qui a le moins de points DDRS gagne 3 points DDRS.", 1);
    liste_carte[18] = new_carte("Jonas Senizergues", "Supprimez toutes les cartes Heures supplementaires retournees du plateau.", 1);
    liste_carte[19] = new_carte("Fetia Bannour", "Si la carte Heures supplementaires est retournee sur le plateau, supprimez toutes les cartes de la ligne et de la colonne où est posee cette carte (y compris celle-ci). Sinon la faction qui a pose cette carte gagne 1 point DDRS par carte Catherine Dubois, Anne-Laure Ligozat, Guillaume Burel, Christophe Mouilleron, Thomas Lim, Julien Forest et Dimitri Watel retournee sur le plateau.", 1);
    liste_carte[20] = new_carte("Catherine Dubois", "Supprimez la première et la dernière cartes de la ligne et de la colonne où est posee cette carte.", 1);
    liste_carte[21] = new_carte("Anne-Laure Ligozat", "Supprimez la première et la dernière cartes de la ligne et de la colonne où est posee cette carte.", 1);
    liste_carte[22] = new_carte("Guillaume Burel", "Si la faction adverse de celle qui a pose cette carte a plus de points DDRS, la seconde lui vole 3 points DDRS.", 1);
    liste_carte[23] = new_carte("Christophe Mouilleron", "Si la carte Heures supplementaires est retournee sur le plateau, supprimez toutes les cartes retournees du plateau sauf les cartes Christophe Mouilleron et Heures supplementaires.", 1);
    liste_carte[24] = new_carte("Thomas Lim", "Si Julien Forest n'est par retourne sur le plateau, la faction qui a pose cette carte gagne 3 points DDRS par carte FISE retournee sur le plateau. Sinon la faction adverse perd 1 point DDRS par carte FISE retournee sur le plateau.", 1);
    liste_carte[25] = new_carte("Julien Forest", "La faction qui a pose cette carte gagne 6 points DDRS par carte FISE retournee sur le plateau si au moins une carte Cafe est retournee sur le plateau.", 1);
    liste_carte[26] = new_carte("Dimitri Watel", "La faction qui a pose cette carte gagne 3 points DDRS par carte FISA ou FC retournee sur le plateau si au moins une carte The est retournee sur le plateau.", 1);
    liste_carte[27] = new_carte("Djibril-Aurelien Dembele-Cabot", "S'il y a plus de 3 cartes retournees sur la ligne de cette carte, la faction qui a pose cette carte gagne 5 points DDRS.", 1);
    liste_carte[28] = new_carte("Eric Lejeune", "Prenez au hasard 5 cartes retournees du plateau (ou toutes les cartes retournees du plateau s'il y a moins de 5). Si une de ces cartes est une carte Catherine Dubois, Anne-Laure Ligozat, Guillaume Burel, Christophe Mouilleron, Thomas Lim, Julien Forest ou Dimitri Watel, melangez les et placez les à gauche de la case la plus à gauche de la première ligne. Les prochaines cartes à être retournees sont ces cartes là. Sinon, supprimez ces cartes du plateau.", 1);
    liste_carte[29] = new_carte("Lucienne Pacave", "S'il y a une carte FISA retournee dans la même ligne ou la même colonne que cette carte, la faction qui a pose cette carte gagne 5 points DDRS.", 1);
    liste_carte[30] = new_carte("Katrin Salhab", "Si les cartes Djibril-Aurelien Djembele-Cabeau, Eric Lejeune et Lucienne Pacave sont retournees, la faction qui a pose cette carte gagne 10 points DDRS. Sinon, retournez toutes les cartes dans la même ligne de cette carte sans appliquer leurs effets.", 1);
    liste_carte[31] = new_carte("Laurent Prevel", "Si Laurent Prevel est la dernière carte retournee du plateau, la faction qui a pose cette carte gagne la manche, quel que soit le nombre de points DDRS des deux factions.", 1);
    liste_carte[32] = new_carte("Laurent Prevel", "Si Laurent Prevel est la dernière carte retournee du plateau, la faction qui a pose cette carte gagne la manche, quel que soit le nombre de points DDRS des deux factions.", 1);
    return liste_carte;
}
